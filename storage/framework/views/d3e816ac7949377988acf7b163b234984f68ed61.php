                    ...
                    <div class="card-rounded bg-white d-flex flex-stack flex-wrap p-2">
                        ...
                        <ul class="nav flex-wrap border-transparent fw-bolder">
                            ...
                            <li class="nav-item my-1">
                                <a class="btn btn-color-gray-600 btn-active-white btn-active-color-primary fw-boldest fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active" data-bs-toggle="tab" href="#ticket"><?php echo e(__('ticket.New Ticket')); ?></a>
                            </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.user", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/f1vyvfuadfip/public_html/resources/views/user/ticket.blade.php ENDPATH**/ ?>