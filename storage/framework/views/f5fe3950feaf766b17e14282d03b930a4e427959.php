            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-admin-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="<?php echo e(__('form.Search admins')); ?>" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-admin-table-toolbar="base">
                        <!--begin::Add admin-->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_admin"><?php echo e(__('form.Add a admin')); ?></button>
                        <!--end::Add admin-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_admins_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px"><?php echo e(__('form.Admin Name')); ?></th>
                            <th class="min-w-125px"><?php echo e(__('form.Email')); ?></th>
                            <th class="min-w-125px"><?php echo e(__('form.Created Date')); ?></th>
        ...
        <div class="modal fade" id="kt_modal_add_admin" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="<?php echo e(url('admin/admins')); ?>" id="kt_modal_add_admin_form" data-kt-redirect="<?php echo e(url("admin/admins")); ?>">
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_add_admin_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder"><?php echo e(__('form.Add a admin')); ?></h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_admin_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_admin_header" data-kt-scroll-wrappers="#kt_modal_add_admin_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-bold mb-2"><?php echo e(__('form.Name')); ?></label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
...
<?php $__env->startSection("after_script"); ?>
    ...
    <script src="<?php echo e(asset('public/assets/js/custom/apps/admins/list.js')); ?>"></script>
    <!--end::Page Custom Javascript-->
    <!--end::Javascript-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/896782.cloudwaysapps.com/epbvaezrzy/public_html/resources/views/admin/index.blade.php ENDPATH**/ ?>