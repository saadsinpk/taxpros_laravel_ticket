            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <?php if(isset($message_to_display)): ?>
                        <?php if($message_to_display == 'pass'): ?>
                            <p style="    font-size: 20px;    font-weight: bold;"><?php echo e(__('form.User is verify now')); ?></p>
                        <?php endif; ?>
                    <?php endif; ?>
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-admin-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="<?php echo e(__('form.Search users')); ?>" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-admin-table-toolbar="base">
                        <!--begin::Add admin-->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_admin"><?php echo e(__('form.Add a user')); ?></button>
                        <!--end::Add admin-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                    <?php if(isset($admin_access['delete_user'])): ?>
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-admin-table-toolbar="selected">
                            <div class="fw-bolder me-5">
                            <span class="me-2" data-kt-admin-table-select="selected_count"></span><?php echo e(__('form.Selected')); ?></div>
                            <button type="button" class="btn btn-danger" data-kt-admin-table-select="delete_selected"><?php echo e(__('form.Delete Selected')); ?></button>
                        </div>
                    <?php else: ?>
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-admin-table-toolbar="selected">
                            <div class="fw-bolder me-5">
                            <span class="me-2" data-kt-admin-table-select="selected_count"></span><?php echo e(__('form.Selected')); ?></div>
                            <button type="button" class="btn btn-danger" data-kt-admin-table-select="delete_selected"><?php echo e(__('form.You are not allow to Delete Selected')); ?></button>
                        </div>
                    <?php endif; ?>
                    <!--end::Group actions-->
                </div>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_admins_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px"><?php echo e(__('form.User Name')); ?></th>
                            <th class="min-w-125px"><?php echo e(__('ticket.Company')); ?></th>
                            <th class="min-w-125px"><?php echo e(__('form.Email')); ?></th>
                            <th class="text-end min-w-70px"><?php echo e(__('form.Actions')); ?></th>
                        </tr>
                        <!--end::Table row-->
                    </thead>
                    <!--end::Table head-->
        ...
        <div class="modal fade" id="kt_modal_add_admin" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="<?php echo e(url('admin/users')); ?>" id="kt_modal_add_admin_form" data-kt-redirect="<?php echo e(url("admin/users")); ?>">
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_add_admin_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder"><?php echo e(__('form.Add a user')); ?></h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_add_admin_cancel" class="btn btn-light me-3"><?php echo e(__('form.Discard')); ?></button>
                            <!--end::Button-->
                            <!--begin::Button-->
...
<?php $__env->startSection("after_script"); ?>
    ...
    <script src="<?php echo e(asset('public/assets/js/custom/apps/users/list.js')); ?>"></script>
    <!--end::Javascript-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/896782.cloudwaysapps.com/epbvaezrzy/public_html/resources/views/admin/user/index.blade.php ENDPATH**/ ?>