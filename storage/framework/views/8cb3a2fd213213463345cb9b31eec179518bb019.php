    ...
    <div class="toolbar">
        ...
        <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
            ...
            <div class="page-title d-flex flex-column me-5">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0"><?php echo e(__('panel.Admin Panel')); ?></h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                    ...
                    <li>
                        <a href="<?php echo e(request()->segment(1)); ?>"><?php echo e(ucfirst(request()->segment(1))); ?></a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                </ul>
            ...
            <div class="d-flex align-items-center pt-3 pt-lg-0">
                <div class="d-flex align-items-center">
                    ...
                    <form id="action-logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="d-none">
                        <?php echo csrf_field(); ?>
                    </form>
                </div>
...
</div><?php /**PATH /home/896782.cloudwaysapps.com/epbvaezrzy/public_html/resources/views/pages/header.blade.php ENDPATH**/ ?>