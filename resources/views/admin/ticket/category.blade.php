            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-admin-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{__('form.Search categories') }}">
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-admin-table-toolbar="base">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add">{{__('form.Add a category') }}</button>
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
            ...
            <div class="modal fade" id="kt_modal_add" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        <!--begin::Form-->
                        <form class="form" action="{{ url('/admin/ticket-category') }}" data-kt-redirect="{{ url("/admin/ticket-category") }}">
                            <!--begin::Modal header-->
                            <div class="modal-header" id="kt_modal_add">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">{{__('form.Add a category') }}</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
...
@section('after_script')
    <script src="{{ asset('public/assets/js/custom/apps/support-center/tickets/category.js') }}"></script>
@endsection
