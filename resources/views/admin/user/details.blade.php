                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table align-middle table-row-dashed gy-5" id="kt_table_users_login_session">
                                                ...
                                                <tbody class="fs-6 fw-bold text-gray-600">
                                                    ...
                                                    <tr>
                                                        <td>{{__('ticket.Address line 1') }}</td>
                                                        <td>   
                                                    ...
                                                    <tr>
                                                        <td>{{__('ticket.Address line 2') }}</td>
                                                        <td>   
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_admin_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_admin_header" data-kt-scroll-wrappers="#kt_modal_update_admin_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div id="kt_modal_update_admin_user_info" class="collapse show">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" name="first_name" id="first_name" value="{{ $user->first_name }}" required/>
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" name="last_name" id="last_name" value="{{ $user->last_name }}" required/>
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" name="address_line_one" id="address_line_one" value="{{ $user->address_line_one }}" />
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" name="address_line_two" id="address_line_two" value="{{ $user->address_line_two }}" />
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" name="country" id="country" value="{{ $user->country }}" />
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" name="city" id="city" value="{{ $user->city }}" />
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" name="state" id="state" value="{{ $user->state }}" />
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" name="postal" id="postal" value="{{ $user->postal }}" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
